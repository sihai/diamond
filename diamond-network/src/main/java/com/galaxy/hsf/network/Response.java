...
public class Response {
	...
	public HSFResponse getResponse() {
		return response;
	}

	public void setResponse(HSFResponse response) {
	 ...
	 * @throws NetworkException
	 */
	public static Response unmarshall(ByteBuffer buffer) throws NetworkException {
