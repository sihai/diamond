 ...
 *
 */
public class HSFClassLoaderDelegateHook implements ClassLoaderDelegateHook, HookConfigurator {
	...
	static {
		String excluded = System.getProperty("com.galaxy.hsf.container.excluded.prefixes");
		if (excluded != null) {
