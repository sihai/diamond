...
public class SimpleConfiguration implements Configuration {
    ...
    private static int hsfServerPort = HSFConstants.DEFAULT_SERVER_PORT;
    private static int hsfServerMaxThreadPoolSize = HSFConstants.DEFAULT_SERVER_MAX_THREAD_POOL_SIZE;
    private static int hsfServerMinThreadPoolSize = HSFConstants.DEFAULT_SERVER_MIN_THREAD_POOL_SIZE;
    private static int consumerProfiler = 3000;
    private static int providerProfiler = 500;
    private static int runmode = HSFConstants.RUN_MODE_TEST;
